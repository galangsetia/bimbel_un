...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        <div id="layoutSidenav_nav">
                ...
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link active" href="http://localhost:8080/bimbel_un/admin">
        ...
        <div id="layoutSidenav_content">
            <main>
            <h2 style="margin-top:30px;margin-left:50px;">Selamat Datang,  <?php echo $this->session->userdata("nama"); ?></h2>
            

            <div class="laporan">
                <div class="row ml-5 mt-5 center justify-content-center">
                <div class="col-xl-3 col-md-6">
                <ol class="breadcrumb mb-4">
                        <h5 class="breadcrumb-item active"> <?php
  ...
  Pendaftar Baru <a href="#" class="alert-link">      <span class="badge badge-light pl-2 pr-2 badge-pill ml-2"> <h5><?php echo $total_pendaftar; ?></h5></span>
</div>

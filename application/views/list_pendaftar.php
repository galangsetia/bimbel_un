...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        ...
        <a class="dropdown-item btn btn-danger btn-active" style="color:red;" href="http://localhost:8080/bimbel_un/login/logout">Logout</a>
            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="http://localhost:8080/bimbel_un/admin">
                        ...
                        <a class="nav-link active" href="http://localhost:8080/bimbel_un/admin/list">
                        ...
                        <a class="nav-link" href="http://localhost:8080/bimbel_un/admin/list_sd">
                        ...
                        <a class="nav-link" href="http://localhost:8080/bimbel_un/admin/list_smp">
                            <div class="sb-nav-link-icon"><svg class="svg-inline--fa fa-table fa-w-16" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="table" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M464 32H48C21.49 32 0 53.49 0 80v352c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V80c0-26.51-21.49-48-48-48zM224 416H64v-96h160v96zm0-160H64v-96h160v96zm224 160H288v-96h160v96zm0-160H288v-96h160v96z"></path></svg>
                                <!-- <i class="fas fa-table"></i> Font Awesome fontawesome.com --></div>
                            Kelas SMP
                        </a>
                      
                        <a class="nav-link" href="http://localhost:8080/bimbel_un/admin/list_sma">
                            <div class="sb-nav-link-icon"><svg class="svg-inline--fa fa-table fa-w-16" aria-hidden="true" focusable="false" data-prefix="fas" data-icon="table" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg=""><path fill="currentColor" d="M464 32H48C21.49 32 0 53.49 0 80v352c0 26.51 21.49 48 48 48h416c26.51 0 48-21.49 48-48V80c0-26.51-21.49-48-48-48zM224 416H64v-96h160v96zm0-160H64v-96h160v96zm224 160H288v-96h160v96zm0-160H288v-96h160v96z"></path></svg>
                                <!-- <i class="fas fa-table"></i> Font Awesome fontawesome.com --></div>
                            Kelas SMA
                        </a>
            ...
            <main>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-end">
                            <div class="col-2">
                            <a type="button" href="http://localhost:8080/bimbel_un/daftar" class="btn btn-sm btn-success justify-content-end mb-5">Tambah Pendaftar</a>
                            </div>
                    </div>
                    ...
                    <div class="card mb-4">
                        ...
                        role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                            ...
                                                            <thead>
                                                            <tr><th rowspan="1" colspan="1">ID</th><th rowspan="1" colspan="1">Nama</th>
                                                            <th rowspan="1" colspan="1">Email</th><th rowspan="1" colspan="1">Ponsel</th>
                                                            <th rowspan="1" colspan="1">Alamat</th><th rowspan="1" colspan="1">Asal Sekolah</th>
                                                            ...
                                                            <?php foreach ($pendaftars->result() as $key): ?>
                                                                    <td class="sorting_1"><?php echo $key->id_pendaftar; ?></td>
                                                                    ...
                                                                    <td><?php echo $key->paket_bimbel; ?></td>
                                                                    <td><?php echo $key->keterangan; ?></td>
                                                                    <td> 
                                                   
                                                                    
                                                                    <button class="btn btn-sm btn-primary text-white"> <?php echo anchor('daftar/edit_pendaftar/'.$key->id_pendaftar,'<font color=white > Konfirmasi </font>'); ?> </button>

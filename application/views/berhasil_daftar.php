...
<body data-spy="scroll" data-target=".fixed-top">
	...
	<header id="header" class="ex-header">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h1 class="white">Pendaftaran Berhasil</h1>
				</div>
			</div>
            <p class="lead"  style="color:white;">Pembayaran Maksimal Hari ini Jam 17.00  <br> Konfirmasi pembayaran dengan mengirimkan foto resi ke admin coding jogja. <br> silahkan klik tombol di bawah</p>
                    <br>
		</div>
		<a href="https://api.whatsapp.com/send?phone=0895806686255" class="btn btn-success" style="text-decoration: none; margin-top:20px">Konfirmasi Pembayaran</a>

		<p class="lead" style="margin-top:50px;"> Jika setelah jam 17.00 tidak ada konfirmasi pembayaran maka data akan di hapus <br> dan harus mendaftar lagi jika ingin konfirmasi pembayaran</p>
	</header>

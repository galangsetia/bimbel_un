            ...
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                <div class="sb-sidenav-menu">
                    <div class="nav">
                        ...
                        <a class="nav-link" href="http://localhost:8080/bimbel_un/admin/list">
                        ...
                        <a class="nav-link active" href="http://localhost:8080/bimbel_un/admin/list_sd">
                    ...
                    <div class="card mb-4">
                        ...
                        role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                                            ...
                                                            <?php foreach ($pendaftars->result() as $key): ?>
                                                                    ...
                                                                    <button class="btn btn-primary text-white"> <?php echo anchor('daftar/edit_pendaftar/'.$key->id_pendaftar,'<font color=white > Konfirmasi </font>'); ?> </button>
                                                                    <button class="btn btn-danger text-white"> <?php echo anchor('daftar/hapus_pendaftar/'.$key->id_pendaftar,'<font color=white > Hapus </font>'); ?> </button>
